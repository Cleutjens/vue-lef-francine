            ...
            <div class="quote">
              ...
              <div class="arrow">
                ...
                >
                  ...
                  <g clip-path="url(#b)">
                    <defs>
                      <path id="c" d="M-676-402H764v855H-676z" />
                    </defs>
                    <clipPath id="d">
                      <use xlink:href="#c" overflow="visible" />
                    </clipPath>
                    <path clip-path="url(#d)" d="M-2-2h94v143H-2z" />
                  </g>
                </svg>
              </div>
            </div>
